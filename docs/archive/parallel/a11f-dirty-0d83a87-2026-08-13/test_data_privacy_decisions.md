...
- **Status**: Completed by creating `desktop_app/resources/signature_template_synthetic_512.jpg`, adding the deterministic generator `tools/generate_synthetic_signature_asset.py`, moving callers to the neutral path, and refreshing the manifest hash.
