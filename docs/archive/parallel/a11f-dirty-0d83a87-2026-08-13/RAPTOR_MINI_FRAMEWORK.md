# Raptor mini (Preview) — Doc + Code Verification Framework

This file documents the framework I (Raptor mini) use to audit and verify docs against the codebase for feature feasibility, implementation status, and product guidance. Save this file to keep continuity across future audits.

Summary

- Name: Raptor mini (Preview) — verification & analysis framework
- Purpose: Provide a repeatable checklist and template for verifying docs vs code, adding status markers, and proposing next steps.
- Location: `docs/RAPTOR_MINI_FRAMEWORK.md`
...
- When you ask me to audit a doc, I will create or update a child file under `docs/analysis/` with the same name using this template and sign it with my name and date. The framework itself is kept at the docs root (`docs/RAPTOR_MINI_FRAMEWORK.md`) so you can re-use it across multiple audits.
