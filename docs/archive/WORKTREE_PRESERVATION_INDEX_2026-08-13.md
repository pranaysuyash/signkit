...
## Addendum (2026-08-13, reconciliation in progress)

Local `main` now contains the incoming `17f644b` baseline plus these reviewed
promotion commits:

- `b631e35`: explicit local-companion versus hosted runtime boundary,
  operator-visible inspection receipts, health proof, and remote-upload guard;
- `6d0e54e`: release configuration, public-surface and deployment gates,
  provider-neutral entitlement receipts, synthetic QA fixtures, and release
  evidence documentation;
- `5798235`: extractor confidence bounds, persisted web inspection receipts,
  isolated document-registration concept proof, browser proof, SignverOD
  research tooling, and autoresearch continuity.

The complete documentation trees from both dirty streams are also preserved in
`docs/archive/parallel/main-dirty-0d83a87-2026-08-13/` and
`docs/archive/parallel/a11f-dirty-0d83a87-2026-08-13/`. Those snapshots retain
