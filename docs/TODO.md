...
- [~] `L1-08` Advance the operator state/recovery contract with the local source-to-ready proof, canonical workflow/companion copy binding, non-retryable malformed-input review state, verified partial-export cleanup, structured library deletion cleanup, explicit local-service retry control, and Tier 4 local companion restart proof; packaged/cross-platform stale-state and accessibility evidence remain open. See `docs/review/local_operator_state_proof_2026-08-13.md`, `docs/review/local_companion_restart_proof_2026-08-13.md`, and QA-35.
