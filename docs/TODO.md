...
- [~] `L1-08` Advance the operator state/recovery contract with the local source-to-ready proof, canonical workflow/companion copy binding, and non-retryable malformed-input review state; timeout, partial-export, cleanup, local-companion process recovery, and accessibility evidence remain open. See `docs/review/local_operator_state_proof_2026-08-13.md` and QA-31.
