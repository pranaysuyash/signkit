...
Claim wording source snapshot: `d86a587d5e947075a39520ff31e35211c151004a`
(`git log -1 --format=%H -- index.html` at the registry review). Update this
snapshot when canonical claim wording changes.
