...
MAIN_SCRIPT = SRC_DIR / "desktop_app" / "main_macos_premium.py"
...
app = BUNDLE(
    coll,
    name='SignKitPremium.app',
    icon=str(SRC_DIR / "assets" / "files" / "SignKit.icns") if (SRC_DIR / "assets" / "files" / "SignKit.icns").exists() else None,
    bundle_identifier='work.signkit.premium.app',
    version='1.0.0',
    info_plist={
        'NSPrincipalClass': 'NSApplication',
        'NSHighResolutionCapable': 'True',
        'CFBundleName': 'SignKit Premium',
        'CFBundleDisplayName': 'SignKit Premium',
